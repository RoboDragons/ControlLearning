%% task3_output_equation.m (課題3: 出力方程式とエンコーダ量子化)
...
for k = 1:N
    ...
    % (状態 x = [x_enc; v_mot] の第1成分 x(1) を Cc * x + Dc で取り出す)
    x_enc = ???;
...
%% ===== Section 4: プロット =====
figure('Name', '課題3: 出力方程式とエンコーダパルス量子化', 'Position', [200, 150, 900, 650]);

%% task4_velocity_estimation.m (課題4: 後退差分と2次LPFによる速度推定)
...
for k = 1:N
    ...
    % (Ts = 0.001 s なので，1秒あたり換算は 1 / Ts = 1000 倍)
    diff_enc      = ???;

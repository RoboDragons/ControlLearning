%% task1_plant_model.m (課題1 解答: プラントモデル導出)
...
% 【課題 1-1 解答】連続時間パラメータ a_m, b_m の導出
% e^(a_m * Ts) = 0.9504 より a_m = ln(0.9504) / Ts
% ゲイン K_c = 0.01039 / (1 - 0.9504) = -b_m / a_m より b_m = K_c * (-a_m)
a_m = log(0.9504) / Ts;
b_m = (0.01039 / (1 - 0.9504)) * (-a_m);

% 【課題 1-2 解答】連続時間状態空間行列 Ac, Bc, 出力行列 Cc, Dc
Ac = [0, K_enc;
      0,   a_m];
...
%% ===== Section 4: プロット =====
figure('Name', '課題1: プラントモデル開ループ応答 (解答)', 'Position', [200, 200, 800, 600]);

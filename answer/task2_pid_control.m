%% task2_pid_control.m (課題2 解答: PIDコントローラと飽和処理)
...
for k = 1:N
    ...
    % 【課題 2-2 解答】PID 制御入力 pid_pwm の計算
...
%% ===== Section 5: プロット =====
figure('Name', '課題2: PID制御と飽和処理 (解答)', 'Position', [200, 150, 900, 650]);
